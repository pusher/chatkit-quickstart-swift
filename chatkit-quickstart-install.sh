...
git clone --branch complete https://github.com/pusher/chatkit-quickstart-swift.git
...
# Inject locator
sed -e "s/YOUR_INSTANCE_LOCATOR/$locator/g" -i .tmp ./Chatkit\ Quickstart/Chatkit.plist
# Inject cluster
sed -e "s/YOUR_CLUSTER/$cluster/g" -i .tmp ./Chatkit\ Quickstart/Chatkit.plist
# Inject instance ID
sed -e "s/YOUR_INSTANCE_ID/$instanceId/g" -i .tmp ./Chatkit\ Quickstart/Chatkit.plist
